...
class BusinessRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get("/stillvalid", decrypttoken_1.decodeReversedJwt, this.IsStillValid.bind(this));
        this.router.post("/token", (0, checkParametersMiddleware_1.default)([
            "uid",
            "displayName",
            "email",
            "emailVerified",
    ...
    getToken(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.business.createToken(req, res);
            }
            catch (error) {
                next(error);
            }
